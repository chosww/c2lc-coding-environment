            ...
            <div className='WorldSelector'>
                ...
                */}
                <AriaDisablingButton
                    ...
                    className={"WorldIcon preview-announce-it" + (this.props.world === 'default' ? " WorldIcon--selected" : "") }
                ...
                <AriaDisablingButton
                    ...
                    className={"WorldIcon preview-announce-it" + (this.props.world === 'forest' ? " WorldIcon--selected" : "") }
                    disabled={this.props.disabled}
                    disabledClassName='WorldIcon--disabled'
                    onClick={this.handleCharacterClick}
                    onKeyDown={this.handleCharacterKeyDown}
                ...
                <AriaDisablingButton
                    ...
                    className={"WorldIcon preview-announce-it" + (this.props.world === 'space' ? " WorldIcon--selected" : "") }
                    disabled={this.props.disabled}
                    disabledClassName='WorldIcon--disabled'
                    onClick={this.handleCharacterClick}
                    onKeyDown={this.handleCharacterKeyDown}
